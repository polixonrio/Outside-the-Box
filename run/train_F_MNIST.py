...
def run_script():
    ...
    for n_classes in range(2, 9+1):
        ...
        # model_path = "CNY19id1_F_MNIST_{}.h5".format(classes_string)  # Original repo's naming convention
        model_path = "CNY19id1_F_MNIST_{}_New.h5".format(classes_string)  # Updated to match renamed model files with _New suffix
        if plot_name == "!":
